...
#define SCY_PAGE_TABLE_INIT_FAILED   ScyHV::vmxroot_error_t::page_table_init_failed
    ...
    /// </summary>
    /// <param name="dst"> - Destination buffer for the read data.</param>
    /// <param name="src"> - Source address in kernel memory.</param>
    /// <param name="size"> - Number of bytes to read.</param>
    LIBSCYHV_API auto read_km(void* dst, void* src, size_t size) -> void;

    /// <summary>
    /// Writes data to kernel memory.
    /// </summary>
    /// <param name="dst"> - Destination address in kernel memory.</param>
    /// <param name="src"> - Source buffer containing the data to write.</param>
    /// <param name="size"> - Number of bytes to write.</param>
    LIBSCYHV_API auto write_km(void* dst, void* src, size_t size) -> void;
