...
#pragma pack (pop)
	...
	__forceinline auto util::get_kmodule_export(const char* module_name, const char* export_name, bool rva) -> void*
	{
		void* buffer = nullptr;
		DWORD buffer_size = NULL;
	...
	__forceinline auto get_pid(const wchar_t* proc_name) -> std::uint32_t
	{
